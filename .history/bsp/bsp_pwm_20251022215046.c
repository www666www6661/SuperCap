...
// TODO: Adapt to current hardware
...
/**
 * @brief start pwm (TODO:check the mode of channel single or waveform)
 *
 * @param ch
 * @return bsp_status_t
 */
...
// TODO:Adapt to current hardware
//  bsp_status_t bsp_pwm_set_realfreq(bsp_pwm_channel_t ch, float freq) {
//    uint16_t arr = 0;
