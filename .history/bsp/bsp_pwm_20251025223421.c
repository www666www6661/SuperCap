...
====================================================================================================
*/
bsp_status_t inline hrtim_pwm_start(uint32_t OutputChannel) {
...
bsp_status_t bsp_pwm_start(bsp_pwm_channel_t ch) {
  if (bsp_pwm_map[ch].tim == &htim1) {
    ...
    extern hrtim_pwm_start hrtim_pwm_start(uint32_t OutputChannel);
    return (hrtim_pwm_start(bsp_pwm_map[ch].channel));
  }
  return BSP_OK;
}
