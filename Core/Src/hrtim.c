...
void MX_HRTIM1_Init(void)
{
  ...
  pADCTriggerCfg.Trigger = HRTIM_ADCTRIGGEREVENT13_TIMERF_CMP2;
  ...
  if (HAL_HRTIM_ADCPostScalerConfig(&hhrtim1, HRTIM_ADCTRIGGER_10, 0x0) != HAL_OK)
  {
    Error_Handler();
  }
  ...
  pCompareCfg.CompareValue = 16000;
  ...
  pCompareCfg.CompareValue = 12000;
  ...
  pDeadTimeCfg.RisingValue = 55;
  pDeadTimeCfg.RisingSign = HRTIM_TIMDEADTIME_RISINGSIGN_POSITIVE;
  pDeadTimeCfg.RisingLock = HRTIM_TIMDEADTIME_RISINGLOCK_WRITE;
  pDeadTimeCfg.RisingSignLock = HRTIM_TIMDEADTIME_RISINGSIGNLOCK_WRITE;
  pDeadTimeCfg.FallingValue = 55;
